        ...
        <div className="flex flex-col overflow-hidden bg-white rounded-md shadow-lg max md:flex-row md:flex-1 lg:max-w-screen-md">
          <div className="p-4 py-6 text-[#404040] bg-[#F7F6F0] md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly">
            ...
            <p className="flex flex-col items-center justify-center mt-10 text-center">
              ...
              <Link href="#" className="underline cursor-pointer hover:-translate-x-1">
                Signup Now!
              </Link>
            </p>
            ...
            <form action="#" className="flex flex-col space-y-5">
              ...
              <div className="flex flex-col space-y-5">
                ...
                <div className="flex flex-col space-y-4">
                  <Link
                    href="#"
                    className="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-gray-800 rounded-md group hover:bg-[#F7F6F0] focus:outline-none"
                  >
                    <span>
                      <svg
                        className="w-5 h-5 text-[#404040] fill-current group-hover:text-[#404040]"
                        viewBox="0 0 16 16"
                        version="1.1"
                        aria-hidden="true"
                      >
                  ...
                  >
                    <span>
                      <svg
                        className="text-[#404040] group-hover:text-[#404040]"
                        width="20"
                        height="20"
                        fill="currentColor"
                      >
